...
public class MainActionGroup extends ActionGroup {
    ...
    private AnAction[] getMenuList() {
        String mainActionId = "ltd.kafka.soonelu.plugins.actions.generate";
        String configActionId = "ltd.kafka.soonelu.plugins.actions.config";
        ActionManager actionManager = ActionManager.getInstance();
        // 代码生成菜单
        AnAction mainAction = actionManager.getAction(mainActionId);
        if (mainAction == null) {
            mainAction = new MainAction("Gen Code");
