...
public class ConfigTableDialog extends JDialog {
    ...
    @ApiModelProperty(value = "表展示")
    private JTable table;
    @ApiModelProperty(value = "添加按钮")
    private JButton addButton;
    @ApiModelProperty(value = "缓存数据工具类")
    private CacheDataUtils cacheDataUtils = CacheDataUtils.getInstance();
    @ApiModelProperty(value = "表信息服务")
    private TableInfoService tableInfoService;
    @ApiModelProperty(value = "默认的表模型")
    ...
    private void initEvent() {
        ...
        addButton.addActionListener(e -> {
            ...
            //输入列名
            String value = Messages.showInputDialog("Column Name:", "Input Column Name:", Messages.getQuestionIcon(),
