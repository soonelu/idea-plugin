...
public abstract class BaseGroupPanel extends JPanel {
    ...
    private void init(String defaultGroupName) {
        ...
        ActionToolbar actionToolbar = ActionManager.getInstance().createActionToolbar("Group Toolbar", actionGroup,
                true);
    ...
    private String inputItemName(String initValue) {
        return Messages.showInputDialog(MsgValue.GROUP_NAME_LABEL, MsgValue.TITLE_INFO, Messages.getQuestionIcon(),
    ...
    private DefaultActionGroup createActionGroup() {
        ...
        actionGroup.add(new AnAction(AllIcons.General.Remove) {
            ...
            public void actionPerformed(@NotNull AnActionEvent e) {
                ...
                // 确认删除？
                if (MessageDialogBuilder.yesNo(MsgValue.TITLE_INFO, String.format(MsgValue.CONFIRM_DELETE_GROUP,
                        groupName)).isYes()) {
            ...
            public void update(@NotNull AnActionEvent e) {
                e.getPresentation().setEnabled(!Objects.equals(comboBox.getSelectedItem(), "Default"));
            }
        });
