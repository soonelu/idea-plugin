...
public class TemplateEditor {
    ...
    public static final String ALL_GEN_TEMPLATE = "EasyCodeTemplate.vm.ft";
    ...
    @ApiModelProperty(value = "编辑器对象")
    private Editor editor;
    @ApiModelProperty(value = "回调结构")
    @Setter
     ...
     * @param fileType    文件类型
     */
    public TemplateEditor(@NotNull Project project, String name, String content, String description,
    ...
    public JComponent createComponent() {
        ...
        PsiFile psiFile = psiFileFactory.createFileFromText(ALL_GEN_TEMPLATE, fileType, content, 0, true);
        ...
        ((EditorEx) editor).setHighlighter(EditorHighlighterFactory.getInstance().createEditorHighlighter(project,
                new LightVirtualFile(name + ".ft")));
