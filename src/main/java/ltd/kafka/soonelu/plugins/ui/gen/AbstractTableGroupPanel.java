...
import ltd.kafka.soonelu.plugins.entity.gen.AbstractGroup;
...
public abstract class AbstractTableGroupPanel<T extends AbstractGroup<E>, E> {
    ...
    protected void init() {
        ...
        //初始化数据
        getCurrGroup().getElementList().forEach(
                e -> tableModel.addRow(toRow(e)));
    ...
    private void initEvent() {
        ...
        addItemButton.addActionListener(e -> {
            ...
            // 输入名称
            String value = Messages.showInputDialog("Item Name:", "Input Item Name", Messages.getQuestionIcon(),
                    "Demo", new InputValidator() {
                        @Override
                        public boolean checkInput(String inputString) {
